...
interface ChatContentProps {
  ...
  handleSubmit: (e?: React.FormEvent, forcedInput?: string) => Promise<void>;
  input: string;
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex items-center gap-1.5">
                    {messages.some(m => m.text.includes("CONFIGURED") || m.text.includes("INTERFERENCE")) ? (
                      <>
                        <div className="w-1 h-1 rounded-full bg-red-500" />
                        <span className="text-[7px] font-mono tracking-[0.2em] uppercase text-red-500/60">Connection_Severed</span>
                      </>
                    ) : (
                      <>
